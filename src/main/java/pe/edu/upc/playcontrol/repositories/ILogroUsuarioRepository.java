...
public interface ILogroUsuarioRepository extends JpaRepository<LogroUsuario, UUID> {
    ...
    long contarLogrosPorUsuario(@Param("usuarioId") UUID usuarioId);
    ...
    Object dashboardProgresoLogros(@Param("usuarioId") UUID usuarioId);
    ...
    List<Object[]> findTimelineDesbloqueos(@Param("usuarioId") UUID usuarioId,
